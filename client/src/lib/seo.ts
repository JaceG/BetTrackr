...
export const seoConfigs = {
	home: {
		...
		description:
			'Track your sports betting balance with detailed analytics, running balance calculations, and visual charts. Import CSV data and monitor your profit/loss over time.',
		keywords:
			'sports betting, betting tracker, bankroll management, betting analytics, profit calculator, ROI tracker, betting balance, sports gambling tracker',
		...
		structuredData: {
			...
			description:
				'Track your sports betting balance with detailed analytics, running balance calculations, and visual charts.',
			operatingSystem: 'Web Browser',
			browserRequirements:
				'Requires JavaScript. Modern browser recommended.',
		},
	},
	...
	landing: {
		...
		description:
			'Most affordable sports betting tracker. Track every bet, tip fee, and expense to know your real ROI. Free forever, premium features available. No account required.',
		keywords:
			'sports betting tracker, betting analytics, tip fee tracker, bankroll management, betting ROI, profit calculator, sports gambling, betting charts',
		...
		structuredData: {
			...
			offers: [
				...
				},
				{
					...
					name: 'Premium Plan',
					description:
						'Cloud sync, multiple bankrolls, and advanced features',
					priceValidUntil: '2026-12-31',
				},
			],
			description:
				'Track your sports betting performance with detailed analytics and know your real profit after all expenses.',
			featureList: [
	...
	login: {
		...
		description:
			'Log in to Sports Betting Charts to sync your betting data across devices and access premium features.',
	...
	signup: {
		...
		description:
			'Create a free account to sync your betting data across devices and unlock cloud backup.',
	...
	subscribe: {
		...
		description:
			'Upgrade to Premium for $9/month. Get cloud sync, multiple bankrolls, streak analysis, advanced export options, and priority support.',
		keywords:
			'sports betting premium, betting tracker subscription, cloud sync betting data',
		...
		structuredData: {
			...
			description:
				'Premium subscription for Sports Betting Charts with cloud sync and advanced features',
			offers: {
				'@type': 'Offer',
				price: '9.00',
				priceCurrency: 'USD',
	...
	account: {
		...
		description:
			'Manage your Sports Betting Charts account, subscription, and settings.',
