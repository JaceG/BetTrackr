			...
			<section className='pt-32 pb-20 px-4 relative overflow-hidden'>
				...
				<div className='max-w-5xl mx-auto text-center relative z-10'>
					...
					<p className='text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto mb-10 leading-relaxed'>
						...
						betting profit. Track every bet, every tip fee, every
						dollar—so you actually know if you're winning.
					</p>
					...
					<div className='flex flex-col sm:flex-row items-center justify-center gap-4 mb-12'>
						<Link href='/'>
							<Button
								size='lg'
								className='bg-emerald-600 hover:bg-emerald-700 text-lg px-8 py-6 h-auto group'>
								Start Tracking Free
				...
				<div className='max-w-6xl mx-auto'>
					<div className='text-center mb-16'>
						<h2 className='text-3xl md:text-4xl font-bold mb-4'>
							Most bettors have no idea if they're actually
							profitable
						</h2>
						<p className='text-lg text-muted-foreground max-w-2xl mx-auto'>
							Between tip service fees, multiple sportsbooks, and
							scattered records— it's nearly impossible to know
							your real ROI. Until now.
						</p>
					</div>
					...
					<div className='grid md:grid-cols-3 gap-8'>
						<Card className='bg-card border-border/50 hover:border-emerald-500/30 transition-colors'>
							<CardContent className='pt-6'>
								...
								<p className='text-muted-foreground'>
									Factor in your tip service costs so you know
									your{' '}
						...
						<Card className='bg-card border-border/50 hover:border-emerald-500/30 transition-colors'>
							<CardContent className='pt-6'>
								...
								<p className='text-muted-foreground'>
									Beautiful charts show your balance over time
									with customizable date ranges.
								</p>
							</CardContent>
						</Card>
						...
						<Card className='bg-card border-border/50 hover:border-emerald-500/30 transition-colors'>
							<CardContent className='pt-6'>
								...
								<p className='text-muted-foreground'>
									Our profit calculator tells you exactly how
									much you need per bet to hit your goals.
								</p>
							</CardContent>
						</Card>
					</div>
					...
					<div className='grid lg:grid-cols-2 gap-12 items-center'>
						<div>
							...
							<p className='text-lg text-muted-foreground mb-6'>
								Watch your bankroll grow (or identify problems
								early) with our interactive balance chart.
								Filter by day, week, month, or view your entire
								history.
							</p>
				...
				<div className='max-w-6xl mx-auto'>
					<div className='grid lg:grid-cols-2 gap-12 items-center'>
						...
						<div className='order-1 lg:order-2'>
							...
							<p className='text-lg text-muted-foreground mb-6'>
								Log your bets with all the details that matter.
								See your running balance after each bet, add
								notes, and export everything for tax season.
							</p>
							<ul className='space-y-3'>
								{[
				...
				<div className='max-w-5xl mx-auto'>
					<div className='text-center mb-12'>
						...
						<p className='text-lg text-muted-foreground'>
							Start tracking for free—no account needed. Upgrade
							for cloud sync and advanced features.
						</p>
					</div>
			...
			<section className='py-20 px-4 bg-card/50'>
				<div className='max-w-5xl mx-auto'>
					<div className='text-center mb-12'>
						...
						<p className='text-lg text-muted-foreground'>
							No signup required. Just open the app and start
							tracking.
						</p>
					</div>
						...
						{[
							{
								...
								description:
									'Enter your starting bankroll to begin tracking your performance.',
							},
							{
								step: '2',
								title: 'Log your bets',
								description:
									'Add each bet with the amount wagered and your winnings or losses.',
							},
							{
								step: '3',
								title: 'Track your profit',
								description:
									'Watch your charts update and know your real ROI after all expenses.',
							},
						].map((item, i) => (
			...
			<section className='py-20 px-4'>
				<div className='max-w-4xl mx-auto text-center'>
					...
					<p className='text-xl text-muted-foreground mb-8 max-w-2xl mx-auto'>
						Join thousands of bettors who finally know whether
						they're winning or losing. Start tracking for free—no
						account required.
					</p>
					<div className='flex flex-col sm:flex-row items-center justify-center gap-4'>
						<Link href='/'>
							<Button
								size='lg'
								className='bg-emerald-600 hover:bg-emerald-700 text-lg px-10 py-6 h-auto'>
								Start Tracking Now
