...
function CheckoutForm({ clientSecret }: { clientSecret: string }) {
	...
	return (
		<form
			...
			className='space-y-6'
			data-testid='form-subscription-payment'>
			<PaymentElement />
			<Button
				type='submit'
...
export default function Subscribe() {
				...
				<Card className='w-full max-w-lg'>
					<CardHeader>
						<CardTitle
							...
							data-testid='text-subscription-active'>
							<CheckCircle2 className='h-5 w-5 text-green-500' />
							Premium Subscription Active
						</CardTitle>
						<CardDescription>
							You're all set! Your data is syncing across all your
							devices.
						</CardDescription>
					</CardHeader>
	...
	return (
		<div className='min-h-screen flex items-center justify-center p-4'>
			<Card className='w-full max-w-lg'>
				<CardHeader>
					<CardTitle data-testid='text-subscription-title'>
						Premium Subscription
					</CardTitle>
					<CardDescription>
						Sync your betting data across all devices with cloud
						storage
					</CardDescription>
				</CardHeader>
					...
					<div className='space-y-3'>
						...
						<div className='flex items-start gap-3'>
							...
							<div>
								...
								<p className='text-sm text-muted-foreground'>
									Never lose your betting history and
									analytics
								</p>
							</div>
						</div>
						...
						<div className='flex items-start gap-3'>
							...
							<div>
								...
								<p className='text-sm text-muted-foreground'>
									Identify winning and losing patterns in your
									betting history
								</p>
							</div>
						</div>
						<div className='flex items-start gap-3'>
							...
							<div>
								...
								<p className='text-sm text-muted-foreground'>
									Track separate bankrolls for different
									strategies or sportsbooks
								</p>
							</div>
						</div>
						<div className='flex items-start gap-3'>
							...
							<div>
								...
								<p className='text-sm text-muted-foreground'>
									PDF reports, Excel formatting, and tax-ready
									exports
								</p>
							</div>
						</div>
						...
						<div className='flex items-start gap-3'>
							...
							<div>
								...
								<p className='text-sm text-muted-foreground'>
									Be the first to try new features before
									anyone else
								</p>
							</div>
						</div>
