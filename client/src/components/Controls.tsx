    ...
    <div className="sticky top-0 z-50 backdrop-blur-md bg-background/90 border-b">
      {!isExpanded ? (
        <div className="p-2 flex items-center gap-2">
          ...
          <span className="text-sm font-semibold flex-shrink-0">Betting Tracker</span>
          {baseline !== null && (
        ...
        <div className="p-2 sm:p-4">
          <div className="max-w-7xl mx-auto space-y-2 sm:space-y-4">
            ...
            <div className="grid grid-cols-2 sm:flex sm:flex-wrap gap-1.5 sm:gap-2">
              ...
              <Button onClick={onAddTipExpense} variant="outline" className="gap-1.5 sm:gap-2 col-span-2 sm:col-span-1 h-10 sm:h-11 text-sm" data-testid="button-add-tip">
                <DollarSign className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                <span className="sm:inline">Add Tip Payment</span>
              </Button>
